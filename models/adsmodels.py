...
class ADsModel(torch.nn.Module):
    ...
    def __init__(self, device, backbone_name='wide_resnet50_2', out_indices=None, checkpoint_path='',
        ...
        self.rgb_backbone = timm.create_model(model_name=backbone_name, pretrained=True,
                                              pretrained_cfg_overlay=dict(
                                                  file='/home/code_project/zgp/3dads_o/3D-ADS-main/model.safetensors'),
                                               **kwargs)
        # self.xyz_backbone = timm.create_model(model_name=backbone_name, pretrained=True,
        #                                       pretrained_cfg_overlay=dict(
        #                                           file='/home/code_project/zgp/3dads_o/3D-ADS-main/model.safetensors'),
        #                                        **kwargs)
        # ## RGB backbone
        ...
        if xyz_backbone_name=='Point_MAE':
            ...
            self.xyz_backbone.load_model_from_ckpt("/home/zgp/Documents/M3DM_5_3080/pointmae_pretrain.pth")
